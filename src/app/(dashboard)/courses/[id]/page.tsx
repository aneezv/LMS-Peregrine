        ...
        <div className="space-y-5 p-5 sm:space-y-6 sm:p-8">
          ...
          {isCourseStaff && (
            <p className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-sm text-amber-800">
              <strong>Preview:</strong> you can open all modules. Learners still need enrollment and unlock times where
              configured.
            </p>
          )}
              ...
              <section key={section.id} className="space-y-3 px-5 py-4 sm:px-8 sm:py-5">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-slate-600">
                    {section.mods.length} module{section.mods.length === 1 ? '' : 's'}
                  </span>
                </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex flex-wrap items-center gap-2 pl-7 text-xs text-slate-600 sm:pl-0">
                              <span className="font-medium text-amber-800">Preview</span>
                              {isTimeLocked && (
